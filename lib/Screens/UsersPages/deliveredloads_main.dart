...
class DeliveredLoadsMain extends StatefulWidget {
  const DeliveredLoadsMain({Key? key}) : super(key: key);

  @override
  State<DeliveredLoadsMain> createState() => _DeliveredLoadsMainState();
}

class _DeliveredLoadsMainState extends State<DeliveredLoadsMain> {
  @override
