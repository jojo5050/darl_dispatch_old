...
class AssignLoadFromPickDrop extends StatefulWidget {
  const AssignLoadFromPickDrop({Key? key}) : super(key: key);

/* final Map<String, dynamic> driverDetail;
 final Map<String, dynamic> staffDetail;*/

  @override
  State<AssignLoadFromPickDrop> createState() => _AssignLoadFromPickDropState();
}

class _AssignLoadFromPickDropState extends State<AssignLoadFromPickDrop>
    with FormValidators {
  ...
  void saveTrailerDetails(int index) {
    trailerID = listOfTrailers![index]["id"];
    Navigator.of(context).pop();
    setState(() {
      trailerPlateNumber = listOfTrailers ![index]["plateNumber"];
    });
    print("vehicle id as ...............$trailerID");
  }

  void saveTruckDetails(int index) {
    truckID = listOfTrucks![index]["id"];
    Navigator.of(context).pop();
    setState(() {
  ...
  void getTodaysDay() {
    ...
    print("current date as .................$formatedDate");
