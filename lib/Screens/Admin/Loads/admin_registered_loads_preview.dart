...
class RegisteredLoadsPreview extends StatefulWidget {
  const RegisteredLoadsPreview({Key? key}) : super(key: key);

  @override
  _RegisteredLoadsPreviewState createState() => _RegisteredLoadsPreviewState();
}

class _RegisteredLoadsPreviewState extends State<RegisteredLoadsPreview> {
